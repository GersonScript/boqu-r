...
# Escrevendo a mensagem "I LOVE YOU"
t.color("Chocolate")
go(-50, -250)  # Ajuste a posição conforme desejado
t.write("I LOVE YOU PRINCESS BEAUTIFUL", align="center", font=("Bradley Hand ITC", 30, "bold"))
